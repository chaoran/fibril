...
#define _fibrili_fork_3(frptr, fn, as) do { \
  ...
  fibrili_membar(_fibrili_##fn##_fork(_fibrili_expand as frptr)); \
} while (0)
...
#define _fibrili_fork_4(frptr, rt, fn, as) do { \
  ...
  fibrili_membar(_fibrili_##fn##_fork(_fibrili_expand as frptr, &rt)); \
} while (0)
...
#define _fibrili_expand(...) \
  _fibrili_expand_(_fibrili_nth(__VA_ARGS__), ## __VA_ARGS__)

#define _fibrili_expand_(n, ...) \
  _fibrili_concat(_fibrili_expand_, n)(__VA_ARGS__)
#define _fibrili_expand_16(...) __VA_ARGS__,
#define _fibrili_expand_15(...) __VA_ARGS__,
#define _fibrili_expand_14(...) __VA_ARGS__,
#define _fibrili_expand_13(...) __VA_ARGS__,
#define _fibrili_expand_12(...) __VA_ARGS__,
#define _fibrili_expand_11(...) __VA_ARGS__,
#define _fibrili_expand_10(...) __VA_ARGS__,
#define _fibrili_expand_9( ...) __VA_ARGS__,
#define _fibrili_expand_8( ...) __VA_ARGS__,
#define _fibrili_expand_7( ...) __VA_ARGS__,
#define _fibrili_expand_6( ...) __VA_ARGS__,
#define _fibrili_expand_5( ...) __VA_ARGS__,
#define _fibrili_expand_4( ...) __VA_ARGS__,
#define _fibrili_expand_3( ...) __VA_ARGS__,
#define _fibrili_expand_2( ...) __VA_ARGS__,
#define _fibrili_expand_1( ...) __VA_ARGS__,
#define _fibrili_expand_0()
